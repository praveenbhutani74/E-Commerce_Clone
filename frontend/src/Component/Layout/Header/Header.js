...
const Header = () => {
  ...
  <ReactNavbar {...options}/>
   ...
   <div className="right-navbar">
      ...
      <Link to={"/search"}>
    <AiOutlineSearch style={{fontSize:"40",position:"absolute",top:"4.8",right:"130",color:"#A94064"}} />
      
      </Link >
      <Link to={"/Cart"}>
       <AiOutlineShoppingCart style={{fontSize:"40",position:"absolute",top:"4.7",right:"90",color:"#A94064"}} />
       </Link>
