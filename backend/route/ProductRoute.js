...
const { getAllProducts,createProduct, updateProduct, deleteProduct, getSingleProduct,CreateProductReview, GetProductReview, DeleteReview } = require('../controller/produtController');
